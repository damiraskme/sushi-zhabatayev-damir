...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_YY_SUSHI_AMP = 3,               /* YY_SUSHI_AMP  */
  YYSYMBOL_YY_SUSHI_BANG = 4,              /* YY_SUSHI_BANG  */
  YYSYMBOL_YY_SUSHI_BAR = 5,               /* YY_SUSHI_BAR  */
  YYSYMBOL_YY_SUSHI_CD = 6,                /* YY_SUSHI_CD  */
  YYSYMBOL_YY_SUSHI_EXIT = 7,              /* YY_SUSHI_EXIT  */
  YYSYMBOL_YY_SUSHI_HISTORY = 8,           /* YY_SUSHI_HISTORY  */
  YYSYMBOL_YY_SUSHI_JOBS = 9,              /* YY_SUSHI_JOBS  */
  YYSYMBOL_YY_SUSHI_LESS = 10,             /* YY_SUSHI_LESS  */
  YYSYMBOL_YY_SUSHI_MORE = 11,             /* YY_SUSHI_MORE  */
  YYSYMBOL_YY_SUSHI_MOREMORE = 12,         /* YY_SUSHI_MOREMORE  */
  YYSYMBOL_YY_SUSHI_PWD = 13,              /* YY_SUSHI_PWD  */
  YYSYMBOL_YY_SUSHI_SET = 14,              /* YY_SUSHI_SET  */
  YYSYMBOL_YY_SUSHI_UNKNOWN = 15,          /* YY_SUSHI_UNKNOWN  */
  YYSYMBOL_YY_SUSHI_TOK = 16,              /* YY_SUSHI_TOK  */
  YYSYMBOL_YYACCEPT = 17,                  /* $accept  */
  YYSYMBOL_cmdline = 18,                   /* cmdline  */
  YYSYMBOL_pipe = 19,                      /* pipe  */
  YYSYMBOL_redir_exe = 20,                 /* redir_exe  */
  YYSYMBOL_in_exe = 21,                    /* in_exe  */
  YYSYMBOL_out_exe = 22,                   /* out_exe  */
  YYSYMBOL_inout_redir = 23,               /* inout_redir  */
  YYSYMBOL_out_redir = 24,                 /* out_redir  */
  YYSYMBOL_any_redir = 25,                 /* any_redir  */
  YYSYMBOL_in_redir = 26,                  /* in_redir  */
  YYSYMBOL_out1_redir = 27,                /* out1_redir  */
  YYSYMBOL_out2_redir = 28,                /* out2_redir  */
  YYSYMBOL_bg_mode = 29,                   /* bg_mode  */
  YYSYMBOL_exe = 30,                       /* exe  */
...
{
       0,    44,    44,    45,    46,    52,    53,    54,    55,    56,
      57,    60,    61,    64,    65,    68,    69,    72,    73,    76,
      77,    80,    81,    84,    85,    86,    88,    89,    90,    93,
      94,    97,   100,   101,   104
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "YY_SUSHI_AMP",
  "YY_SUSHI_BANG", "YY_SUSHI_BAR", "YY_SUSHI_CD", "YY_SUSHI_EXIT",
  "YY_SUSHI_HISTORY", "YY_SUSHI_JOBS", "YY_SUSHI_LESS", "YY_SUSHI_MORE",
  "YY_SUSHI_MOREMORE", "YY_SUSHI_PWD", "YY_SUSHI_SET", "YY_SUSHI_UNKNOWN",
  "YY_SUSHI_TOK", "$accept", "cmdline", "pipe", "redir_exe", "in_exe",
  "out_exe", "inout_redir", "out_redir", "any_redir", "in_redir",
  "out1_redir", "out2_redir", "bg_mode", "exe", "args", "arg", YY_NULLPTR
};
...
#line 46 "sushi_yyparser.y"
                       {
  (yyvsp[-1].pp)->hd()->set_pipe((yyvsp[-2].p));
  Program *last = (yyvsp[-1].pp)->tl();
  delete (yyvsp[-1].pp);
  my_shell.spawn(last, (yyvsp[0].b));
 }
#line 1129 "sushi_yyparser.tab.c"
    break;

  case 5: /* cmdline: arg YY_SUSHI_SET arg  */
#line 52 "sushi_yyparser.y"
                       { my_shell.putenv((yyvsp[-2].s), (yyvsp[0].s)); }
#line 1135 "sushi_yyparser.tab.c"
    break;

  case 6: /* cmdline: YY_SUSHI_PWD  */
#line 53 "sushi_yyparser.y"
                       { my_shell.pwd(); }
#line 1141 "sushi_yyparser.tab.c"
    break;

  case 7: /* cmdline: YY_SUSHI_CD arg  */
#line 54 "sushi_yyparser.y"
                       { my_shell.cd((yyvsp[0].s)); }
#line 1147 "sushi_yyparser.tab.c"
    break;

  case 8: /* cmdline: YY_SUSHI_HISTORY  */
#line 55 "sushi_yyparser.y"
                   { my_shell.show_history(); }
#line 1153 "sushi_yyparser.tab.c"
    break;

  case 9: /* cmdline: YY_SUSHI_BANG  */
#line 56 "sushi_yyparser.y"
                   { my_shell.re_parse((yyvsp[0].i)); }
#line 1159 "sushi_yyparser.tab.c"
    break;

  case 10: /* cmdline: YY_SUSHI_EXIT  */
#line 57 "sushi_yyparser.y"
                   { my_shell.set_exit_flag(); }
#line 1165 "sushi_yyparser.tab.c"
    break;

  case 11: /* pipe: YY_SUSHI_BAR out_exe  */
#line 60 "sushi_yyparser.y"
                            { (yyval.pp) = new Pipe((yyvsp[0].p)); }
#line 1171 "sushi_yyparser.tab.c"
    break;

  case 12: /* pipe: pipe YY_SUSHI_BAR out_exe  */
#line 61 "sushi_yyparser.y"
                            { (yyvsp[0].p)->set_pipe((yyvsp[-2].pp)->tl()); (yyvsp[-2].pp)->tl((yyvsp[0].p)); (yyval.pp) = (yyvsp[-2].pp); }
#line 1177 "sushi_yyparser.tab.c"
    break;
...
#line 1189 "sushi_yyparser.tab.c"
    break;
...
#line 69 "sushi_yyparser.y"
               { (yyvsp[-1].p)->set_redir((yyvsp[0].redir)); (yyval.p) = (yyvsp[-1].p); }
#line 1201 "sushi_yyparser.tab.c"
    break;
